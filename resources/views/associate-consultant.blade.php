                ...
                <div class="col-lg-12 career-form mt-5">
                    ...
                    <form method="post" action="{{ route('store') }}" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered academic">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="pg_college" value="{{ old('pg_college') }}"
                                                class="form-control" placeholder="College/Institute" required></td>
                                        <td><input type="text" name="pg_university"
                                                value="{{ old('pg_university') }}" class="form-control"
                                                placeholder="Board/University" required></td>
                                        <td><input type="number" name="pg_year" value="{{ old('pg_year') }}"
                                                class="form-control" placeholder="Year" required></td>
                                        <td><input type="number" step="any" name="pg_percentage"
                                                value="{{ old('pg_percentage') }}" class="form-control"
                                                placeholder="% of Marks" required></td>
                                        <td><input type="text" name="pg_position" value="{{ old('pg_position') }}"
                                                class="form-control" placeholder="Rank/Position"></td>
                                        <td><input type="text" name="pg_attempt" value="{{ old('pg_attempt') }}"
                                                class="form-control" placeholder="Attempt"></td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="ss_college" value="{{ old('ss_college') }}"
                                                class="form-control" placeholder="College/Institute" required></td>
                                        <td><input type="text" name="ss_university"
                                                value="{{ old('ss_university') }}" class="form-control"
                                                placeholder="Board/University" required></td>
                                        <td><input type="number" name="ss_year" value="{{ old('ss_year') }}"
                                                class="form-control" placeholder="Year" required></td>
                                        <td><input type="number" step="any" name="ss_percentage"
                                                value="{{ old('ss_percentage') }}" class="form-control"
                                                placeholder="% of Marks" required></td>
                                        <td><input type="text" name="ss_position" value="{{ old('ss_position') }}"
                                                class="form-control" placeholder="Rank/Position"></td>
                                        <td><input type="text" name="ss_attempt" value="{{ old('ss_attempt') }}"
                                                class="form-control" placeholder="Attempt"></td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td>DM / MCH/DNB </td>
                                        <td><input type="text" name="dm_mch_dnb_college"
                                                value="{{ old('dm_mch_dnb_college') }}" class="form-control"
                                                placeholder="College/Institute" required></td>
                                        <td><input type="text" name="dm_mch_dnb_university"
                                                value="{{ old('dm_mch_dnb_university') }}" class="form-control"
                                                placeholder="Board/University" required></td>
                                        <td><input type="number" name="dm_mch_dnb_year"
                                                value="{{ old('dm_mch_dnb_year') }}" class="form-control"
                                                placeholder="Year" required></td>
                                        <td><input type="number" step="any" name="dm_mch_dnb_percentage"
                                                value="{{ old('dm_mch_dnb_percentage') }}" class="form-control"
                                                placeholder="% of Marks" required></td>
                                        <td><input type="text" name="dm_mch_dnb_position"
                                                value="{{ old('dm_mch_dnb_position') }}" class="form-control"
                                                placeholder="Rank/Position"></td>
                                        <td><input type="text" name="dm_mch_dnb_attempt"
                                                value="{{ old('dm_mch_dnb_attempt') }}" class="form-control"
                                                placeholder="Attempt"></td>
                                    </tr>
                                    <tr>
                                        <td>9</td>
                                        <td>FELLOWSHIP </td>
                                        <td><input type="text" name="fellowship_college"
                                                value="{{ old('fellowship_college') }}" class="form-control"
                                                placeholder="College/Institute" required></td>
                                        <td><input type="text" name="fellowship_university"
                                                value="{{ old('fellowship_university') }}" class="form-control"
                                                placeholder="Board/University" required></td>
                                        <td><input type="number" name="fellowship_year"
                                                value="{{ old('fellowship_year') }}" class="form-control"
                                                placeholder="Year" required></td>
                                        <td><input type="number" step="any" name="fellowship_percentage"
                                                value="{{ old('fellowship_percentage') }}" class="form-control"
                                                placeholder="% of Marks" required></td>
                                        <td><input type="text" name="fellowship_position"
                                                value="{{ old('fellowship_position') }}" class="form-control"
                                                placeholder="Rank/Position"></td>
                                        <td><input type="text" name="fellowship_attempt"
                                                value="{{ old('fellowship_attempt') }}" class="form-control"
                                                placeholder="Attempt"></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="form-group submit-button text-center">
                            <button type="submit"
                                class="btn px-4 fs-6 blue-hover submit-button ms-auto mt-4">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
