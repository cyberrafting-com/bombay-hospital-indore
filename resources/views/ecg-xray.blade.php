@php($title = "ECG & X-Ray | Bombay Hospital Indore")
        ...
        <div class="row">
            <div class="col">
                <div class=" breadcrumb-holder">
                    ...
                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">ECG & X-Ray</h4>
                ...
                <div class="txt-block pr-30">
                    ...
                    <div class="content-block mb-40">
                        <div class="content-block-img">
                            <img class="img-fluid" src="{{ asset('/resources/assets/images/services/ecg-xray.jpg')}}"
                                alt="content-image">
                        </div>
                        ...
                        <p>An x-ray (radiograph) is a non-invasive medical test that helps physicians diagnose and treat
                            ...
                            At Bombay Hospital, we use fully digital x-ray techniques. The department is located on the
                            Basement of Bombay Hospital Building where most of the General Radiology work is done.</p>
