        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 career-form mt-5">
                    ...
                    <div class="form-row">
                        <div class="form-group car col-lg-12" style="display: flex; align-items: center;">
                            <label for="current-address" style="margin-right: 10px; min-width: 150px;">Current Address:</label>
                    ...
                    <div class="form-row">
                        <div class="form-group car col-lg-6" style="display: flex; align-items: center;">
                            ...
                            <input type="text" name="marital_status" readonly value="{{ $personal_information->marital_status }}" style="flex: 1;">
                        </div>
                        <div class="form-group car col-lg-6" style="display: flex; align-items: center;">
                            <label for="spouse-details" style="margin-right: 10px; min-width: 200px;">If married, details of Spouse:</label>
                    ...
                    <div class="form-row">
                        <div class="form-group car col-lg-6" style="display: flex; align-items: center;">
                            ...
                            <input type="number" id="mobile" name="mobile" placeholder="Mobile No" readonly value="{{ $personal_information->mobile }}" style="flex: 1;">
                        </div>
                        <div class="form-group car col-lg-6" style="display: flex; align-items: center;">
                    ...
                    <div class="form-row">
                        <div class="form-group car col-lg-6" style="display: flex; align-items: center;">
                            ...
                            <input type="text" id="medical-registration" name="medical_registration" placeholder="Medical Council Registration No (MBBS/BDS/BHMS)" readonly value="{{ $personal_information->medical_registration }}" style="flex: 1;">
                        </div>
                        <div class="form-group car col-lg-6" style="display: flex; align-items: center;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered academic">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><input type="text" class="form-control" name="designation_1" placeholder="Designation" value="{{ $personal_information->designation_1 }}" readonly></td>
                                    <td><input type="text" class="form-control" name="duration_period_1" placeholder="Duration" value="{{ $personal_information->duration_period_1 }}" readonly></td>
                                    <td><input type="text" class="form-control" name="institution_1" placeholder="Institution" value="{{ $personal_information->institution_1 }}" readonly></td>
                                    <td><input type="text" class="form-control" name="details_1" placeholder="Details" value="{{ $personal_information->details_1 }}" readonly></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td><input type="text" class="form-control" name="designation_2" placeholder="Designation" value="{{ $personal_information->designation_2 }}" readonly></td>
                                    <td><input type="text" class="form-control" name="duration_period_2" placeholder="Duration" value="{{ $personal_information->duration_period_2 }}" readonly></td>
                                    <td><input type="text" class="form-control" name="institution_2" placeholder="Institution" value="{{ $personal_information->institution_2 }}" readonly></td>
                                    <td><input type="text" class="form-control" name="details_2" placeholder="Details" value="{{ $personal_information->details_2 }}" readonly></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="form-group car" style="display: flex; align-items: center;">
                        <label for="remuneration" style="margin-right: 10px; min-width: 200px;">Academic Activities & Publications:</label>
                        <textarea id="achievements" name="activities" rows="2" readonly placeholder="Academic Activities & Publications">{{ $personal_information->activities }}</textarea>
                        
                    </div>
                    <div class="form-group car"  style="display: flex; align-items: center;">
                        <label for="remuneration" style="margin-right: 10px; min-width: 200px;">Any Other Achievements:</label>
                    ...
                    <div class="form-group car"  style="display: flex; align-items: center;">
                        <label for="remuneration" style="margin-right: 10px; min-width: 200px;">Languages Known:</label>
