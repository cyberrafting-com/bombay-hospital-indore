@php($title = "Career -  Post OF Surgical Oncologist | Bombay Hospital Indore")
        ...
        <div class="row">
            <div class="col">
                <div class=" breadcrumb-holder">
                    ...
                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">Career/ Surgical Oncologist</h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered academic ">
                            ...
                            <tr>
                                    ...
                                    <td><input type="text" class="form-control" name="exp-details1" placeholder="Details" readonly></td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td><input type="text" class="form-control" name="exp-details2" placeholder="Details" readonly></td>
                                </tr>
