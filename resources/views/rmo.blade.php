@php($title = "Career -  Post OF SR. RMO/RMO / CMO | Bombay Hospital Indore")
        ...
        <div class="row">
            <div class="col">
                <div class=" breadcrumb-holder">
                    ...
                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">Career/ Post OF SR. RMO/RMO/CMO</h4>
			...
			@endif
                ...
                @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group car col-lg-6">
                            <input placeholder="DOB" class="textbox-n" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" name="dob" required>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group car col-lg-6">
                        <select id="status" name="marital-status"  style="color:  #626161 !important;" >
                   ...
                   <div class="form-row">
                        <div class="form-group car col-lg-6">
                            <input type="text" id="registration" name="medical-registration" placeholder="Medical Council Registration No (MBBS/BDS/BHMS)" required>
                        </div>
                        <div class="form-group car col-lg-6">
                        ...
                        <table class="table table-bordered academic">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>SSC</td>
                                    <td><input type="text" class="form-control" placeholder="College/Institute" required name="ssc-colg"></td>
                                    <td><input type="text" class="form-control" placeholder="Board/University" required name="ssc-board"></td>
                                    <td><input type="text" class="form-control" placeholder="Year" name="ssc-year" required></td>
                                    <td><input type="text" class="form-control" placeholder="% of Marks" required name="ssc-marks"></td>
                                    <td><input type="text" class="form-control" name="ssc-rank" placeholder="Rank/Position"></td>
                                    <td><input type="text" class="form-control" name="ssc-attempt" placeholder="Attempt"></td>
                                </tr>
                    ...
                    <div class="form-group car">
                        <textarea id="achievements" name="any-achievements" rows="2" placeholder="Any Other Achievements"></textarea>
                    </div>
                    <div class="form-group car">
