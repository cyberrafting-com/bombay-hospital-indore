@php($title = 'Career - Medical Administrator| Bombay Hospital Indore')
            ...
            <div class="row">
                <div class="col">
                    <div class=" breadcrumb-holder">
                        ...
                        <!-- Title -->
                        <h4 class="h4-sm steelblue-color">Career/ Medical Administrator</h4>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 career-form mt-5">
                    <form method="post" action="{{ route('administrator') }}" enctype="multipart/form-data">
                        @csrf

                        <input type="hidden" name="form_name" value="Medical Administrator">
