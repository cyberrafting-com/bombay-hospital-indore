@php($title = 'Career - Post OF Junior Resident Medical Officers | Bombay Hospital Indore')
            ...
            <div class="row">
                <div class="col">
                    <div class=" breadcrumb-holder">
                        ...
                        <!-- Title -->
                        <h4 class="h4-sm steelblue-color">Career/ Junior Resident Medical Officers</h4>
