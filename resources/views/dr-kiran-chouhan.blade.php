@php($title = "Dr. Kiran Chouhan | Bombay Hospital Indore")
        ...
        <div class="row">
            <div class="col">
                <div class=" breadcrumb-holder">
                    ...
                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">Dr. Kiran Chouhan</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="doctor-photo mb-40">
                    ...
                    <!-- Photo -->
                    <img class="img-fluid" src="{{ asset('/resources/assets/images/team/dr-kiran-chouhan.jpg')}}" alt="">
