@php($title = "Dr. Rakesh Shukla | Bombay Hospital Indore")
        ...
        <div class="row">
            <div class="col">
                <div class=" breadcrumb-holder">
                    ...
                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">Dr. Rakesh Shukla</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="doctor-bio">
                    ...
                    <!-- Text -->
                    <!-- <p>Dr. Rajesh Gujrati obtained his medical degree from MGM Medical College, Devi Ahilya University, Indore. He completed his Post Graduate studies in Surgery and Surgical Oncology from Tata Memorial Hospital, University of Bombay, Mumbai in the year 1991.</p>
                            <p>He further went on to successfully complete his fellowship in Surgical Oncology in different departments at Tata Memorial Hospital, Mumbai, between 1991-1994. In December 1994, he went to United States of America for a specialized training in the field of Head and Neck Cancer Surgery in the capacity of a clinical Research fellow at Memorial Sloan Kettering Cancer Centre, New York, USA and Mayo Clinic, Rochester, Minnesota, USA. He had a further specialized training programme at National Cancer Institute Tokyo, Japan for learning intricacies of Esophageal and Lung Cancer Surgery in the year 2002.</p>
