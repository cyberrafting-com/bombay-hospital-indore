@php($title = "Dr. Sonia Daga | Bombay Hospital Indore")
        ...
        <div class="row">
            <div class="col">
                <div class=" breadcrumb-holder">
                    ...
                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">Dr. Sonia Daga</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="doctor-photo mb-40">
                    ...
                    <!-- Photo -->
                    <img class="img-fluid" src="{{ asset('/resources/assets/images/team/dr-sonia-daga.jpg')}}" alt="">
