...
<html>
  <head>
    ...
    <title> Referral Hospital |Log-in </title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        ...
        <a href="#"><b>Referral Hospital</b>Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Hospital in </p>
        <?php  echo msg_alert_backend();  ?>
        <?php echo form_open(current_url()); ?>
          <div class="form-group has-feedback">
          <input type="text" class="form-control" name="hospital_id" id="exampleInputEmail1" value="<?php echo  set_value('hospital_id'); ?>"  placeholder="Hospital ID">
