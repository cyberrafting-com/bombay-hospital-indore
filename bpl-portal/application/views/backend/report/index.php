    ...
    <div class="row">
      ...
      <div class="box-body">
        <?php  echo msg_alert_backend();  ?>
          ...
          <form class="form-inline"  id="report_form"  action="<?php echo base_url('backend/reports/index/') ?>" role="form">
        <div class="col-md-2">    
...
<div class="col-md-2">    
          ...
          <a class="btn btn-warning" href="<?php echo base_url('backend/reports/index/');  ?>"  style="margin-top:0px;"class="btn btn-small">Reset</a> 
        </div>
        </div>
                ...
                <tr class="gradeX">
                    ...
                    <td class="to_hide_phone">
                      <?php if($value->admit_status==2){ echo '<span class="label label-success">Discharged</span>'; }else{ echo '-'; } ?> 
                       <a href="<?php echo base_url().'backend/reports/view_detail/'.$value->id.'/'.$offset; ?>" class="btn btn-success btn-xs" >Detail</a>    
                    </td>
                    <td><?php if(!empty($value->admit_date)){  echo date('d-m-Y',strtotime($value->admit_date)); }else{ echo '--'; } ?></td>
