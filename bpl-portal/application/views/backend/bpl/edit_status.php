 ...
 <div class="clearfix"></div>
    <form action="<?php  echo current_url();  ?>" method="post" accept-charset="utf-8">
              ...
              <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="bed_no" id="ward_bed" <?php if(!empty($register_data->unit_type) && $register_data->unit_type=='ward'){ echo 'style="display:block"';  }else{   echo 'disabled="disabled" style="display:none"';   } ?>  class="form-control" >
						...
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='751'){ echo 'selected'; } ?> value="751">751 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='752'){ echo 'selected'; } ?> value="752">752 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='753'){ echo 'selected'; } ?> value="753">753 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='754'){ echo 'selected'; } ?> value="754">754 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='755'){ echo 'selected'; } ?> value="755">755 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='756'){ echo 'selected'; } ?> value="756">756 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='757'){ echo 'selected'; } ?> value="757">757 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='758'){ echo 'selected'; } ?> value="758">758 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='759'){ echo 'selected'; } ?> value="759">759 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='760'){ echo 'selected'; } ?> value="760">760 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='761'){ echo 'selected'; } ?> value="761">761 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='762'){ echo 'selected'; } ?> value="762">762 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='763'){ echo 'selected'; } ?> value="763">763 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='764'){ echo 'selected'; } ?> value="764">764 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='765'){ echo 'selected'; } ?> value="765">765 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='766'){ echo 'selected'; } ?> value="766">766 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='767'){ echo 'selected'; } ?> value="767">767 </option>
						<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='768'){ echo 'selected'; } ?> value="768">768</option>
                    </select>
              ...
              <select name="bed_no" id="icu_bed"  <?php if(!empty($register_data->unit_type) && $register_data->unit_type=='icu'){ echo 'style="display:block"';  }else{   echo 'disabled="disabled" style="display:none"';   } ?>  class="form-control"  >
				...
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='751'){ echo 'selected'; } ?> value="751">751 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='752'){ echo 'selected'; } ?> value="752">752 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='753'){ echo 'selected'; } ?> value="753">753 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='754'){ echo 'selected'; } ?> value="754">754 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='755'){ echo 'selected'; } ?> value="755">755 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='756'){ echo 'selected'; } ?> value="756">756 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='757'){ echo 'selected'; } ?> value="757">757 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='758'){ echo 'selected'; } ?> value="758">758 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='759'){ echo 'selected'; } ?> value="759">759 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='760'){ echo 'selected'; } ?> value="760">760 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='761'){ echo 'selected'; } ?> value="761">761 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='762'){ echo 'selected'; } ?> value="762">762 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='763'){ echo 'selected'; } ?> value="763">763 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='764'){ echo 'selected'; } ?> value="764">764 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='765'){ echo 'selected'; } ?> value="765">765 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='766'){ echo 'selected'; } ?> value="766">766 NICU</option>
				<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='767'){ echo 'selected'; } ?> value="767">767 NICU</option>
					<option <?php if($register_data->bed_no!='' &&  $register_data->bed_no=='768'){ echo 'selected'; } ?> value="768">768 NICU</option>
              ...
              <div class="clearfix"></div>
               <div class="col-md-3">
                ...
                <select name="city" class="form-control" placeholder="City">
                      ...
                      <option <?php if(!empty($register_data->city) && $register_data->city=='rajgarh'){ echo 'selected="selected"';  } ?> value="rajgarh">Rajgarh</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='morena'){ echo 'selected="selected"';  } ?> value="morena">Morena</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='sheopur'){ echo 'selected="selected"';  } ?> value="sheopur">Sheopur</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='ashoknagar'){ echo 'selected="selected"';  } ?> value="ashoknagar">Ashoknagar</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='shivpuri'){ echo 'selected="selected"';  } ?> value="shivpuri">Shivpuri</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='alirajpur'){ echo 'selected="selected"';  } ?> value="alirajpur">Alirajpur</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='barwani'){ echo 'selected="selected"';  } ?> value="barwani">Barwani</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='dhar'){ echo 'selected="selected"';  } ?> value="dhar">Dhar</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='jhabua'){ echo 'selected="selected"';  } ?> value="jhabua">Jhabua</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='balaghat'){ echo 'selected="selected"';  } ?> value="balaghat">Balaghat</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='mandla'){ echo 'selected="selected"';  } ?> value="mandla">Mandla</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='narsinghpur'){ echo 'selected="selected"';  } ?> value="narsinghpur">Narsinghpur</option>    
<option <?php if(!empty($register_data->city) && $register_data->city=='dindori'){ echo 'selected="selected"';  } ?> value="dindori">Dindori</option>     
<option <?php if(!empty($register_data->city) && $register_data->city=='harda'){ echo 'selected="selected"';  } ?> value="harda">Harda</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='sidhi'){ echo 'selected="selected"';  } ?> value="sidhi">Sidhi</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='panna'){ echo 'selected="selected"';  } ?> value="panna">Panna</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='tikamgarh'){ echo 'selected="selected"';  } ?> value="tikamgarh">Tikamgarh</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='anuppur'){ echo 'selected="selected"';  } ?> value="anuppur">Anuppur</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='shahdol'){ echo 'selected="selected"';  } ?> value="shahdol">Shahdol</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='umaria'){ echo 'selected="selected"';  } ?> value="umaria">Umaria</option>   
<option <?php if(!empty($register_data->city) && $register_data->city=='agar-malwa'){ echo 'selected="selected"';  } ?> value="agar-malwa">Agar Malwa</option> 
