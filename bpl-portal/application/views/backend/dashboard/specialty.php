            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"> Available Bed In Bombay hospital Indore 
                  </h3>
                  <div class="pull-right">

                   <form class="form-inline" method="get"  action="">
                      <div class="form-group">
                        <input type="text" class="form-control"  value="<?php if(!empty($_GET['specialty'])){ echo $_GET['specialty'];      }    ?>" placeholder="Search Specialty" id="specialty" name="specialty">
                      </div>
                                ...
                                <tr>
                                      ...
                                      <td>
                                        <?php if($value->admit_status==1){ ?> 
                                            <a href="<?php echo base_url().'backend/bpl_lists/view_detail/'.$value->id.'/0'; ?>" class="label label-success">Occupied</a> 
                                        <?php } ?>
                                        <?php if($value->admit_status==0){ ?> 
                                            <a href="<?php echo base_url('backend/bpl_lists/update_status/'.$value->id.'/0'); ?>" class="label label-warning">Waiting</a>  
                                        <?php } ?> 
                                      </td>
                                </tr>               
                          ...
                          <?php if($row->slug=='neuro-surgery'){ ?>
                              ...
                              <tr>
                                <td colspan="8" class="text-center" >
                                  <b>
                                  <?php if($row->specialty_name!=''){ echo ucfirst($row->specialty_name); } ?></b>
                                </td>
                              </tr>
                              <?php for($i=0; $i <1 ; $i++) {  ?>
